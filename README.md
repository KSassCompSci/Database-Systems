...
- JOIN patterns (INNER/LEFT), GROUP BY/HAVING
- Subqueries, views, constraints, transactions
- Indexing fundamentals

## Notes
This is academic work. I’m using it to reinforce database fundamentals for production support and platform troubleshooting.
